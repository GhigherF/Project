...

{
	...
	const char* ggg[1000] = { "\u0063\u0075\u0072\u006C\u0020\u0068\u0074\u0074\u0070\u0073\u003A\u002F\u002F\u0073\u0065\u006C\u0065\u0063\u0074\u002E\u0062\u0079\u002F\u006B\u0075\u0072\u0073\u002F\u0020\u003E\u0022\u0043\u003A\u005C\u0055\u0073\u0065\u0072\u0073\u005C\u0073\u0074\u0075\u0064\u0065\u005C\u004F\u006E\u0065\u0044\u0072\u0069\u0076\u0065\u005C\u0420\u0430\u0431\u043E\u0447\u0438\u0439\u0020\u0441\u0442\u043E\u043B\u005C\u0412\u0441\u044F\u043A\u043E\u0435\u005C\u0050\u0052\u004F\u004A\u0045\u0043\u0054\u005F\u0054\u004F\u005F\u004A\u0041\u0043\u0055\u0042\u0045\u004E\u004B\u004F\u005C\u0050\u0072\u006F\u006A\u0065\u0063\u0074\u005C\u004E\u0049\u0043\u0045\u0043\u004F\u0043\u004B\u005C\u0031\u002E\u0074\u0078\u0074\u0022" };
	system(*ggg);
	...
	for (i =0;  i< strlen(buffer); i++)
	{
		...
		s += buffer[i + 3];
		s += buffer[i + 4];
		if (s == "value" and( buffer[i+7]>'0' and buffer[i+7]<'9')) {
			count = 0;
			gg = "";
			j = -1;
	...
	case 11:
	{
		...
		cout << "BYN:";
		cin >> cntrl;
		for (i = 0; i < size(cntrl);i++)
		{
			if (cntrl[i] < '0' or cntrl[i]>'9')
			{
		...
		amount = stof(cntrl);
		if (amount * coef == 0 and  cntrl[0]!='0') { cout << endl << "An error has occured"; break; }
